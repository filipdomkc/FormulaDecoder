...
const Hero = () => {
  return (
    <div className='text-white' id='Home'>
        <div className='max-w-[800px] w-full h-screen pt-24 mx-auto my-auto text-center flex flex-col justify-center'>
            ...
            <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-black'><a href='#DropIn'>Get started</a></button>
        </div>
    </div>
  )
}
